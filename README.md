...
[alt-text.org](https://alt-text.org) backend. *Note: since this was written the chosen algorithm has been implemented in [Rust](https://github.com/alt-text-org/image-match-rs)*.
